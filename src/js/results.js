...
const getResultPage = function(stats) {
    return `${getLastDefinition(stats.games)}`;
};

const getStatsSeparator = function() {
...
const getStatsResultPage = function(stats) {
    ...
    ${stats.games && stats.games.length>0 ? getStatsSeparator() : ""}
...
export { getResultModal, getResultPage, getStatsResultPage };